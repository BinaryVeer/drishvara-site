...
if (draft.selected_article.sha256_before_ag08e !== selectedHash) fail("Draft selected article hash mismatch");
if (readiness.selected_article_sha256_before_ag08e !== selectedHash) fail("Readiness selected article hash mismatch");
if (ag08dInference.selected_article_sha256_before_ag08d !== selectedHash) fail("AG08E hash must match AG08D hash");
