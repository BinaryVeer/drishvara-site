...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag20cCandidate.candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("Candidate hash mismatch or AG12C-R1 repaired article state missing");
