...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag21cPackage.seed_candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("AG21C candidate hash mismatch or AG12C-R1 repaired article state missing");
