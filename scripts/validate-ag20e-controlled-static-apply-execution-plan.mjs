...
if (!hashPairMatchesCurrentOrAg12cR1Repair(fileMutationOrder.candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("File mutation order hash mismatch or AG12C-R1/AR01-R1 approved repair-chain state missing");
