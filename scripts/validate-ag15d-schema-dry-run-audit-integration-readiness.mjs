...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag15cIntake.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("AG15C intake hash mismatch or AG12C-R1 repaired article state missing");
