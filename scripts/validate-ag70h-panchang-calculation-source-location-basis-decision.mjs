...
if (panchangManifest.status !== "production_bank_manifest_created_panchang_calculation_source_location_basis_decision") fail("Panchang manifest status mismatch.");
