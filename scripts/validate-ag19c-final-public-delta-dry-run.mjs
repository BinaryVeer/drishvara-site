...
if (!hashPairMatchesCurrentOrAg12cR1Repair(finalDelta.candidate_article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("Candidate article hash mismatch or AG12C-R1/AR01-R1 approved repair-chain state missing");
