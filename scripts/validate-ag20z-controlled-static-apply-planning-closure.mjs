...
if (!hashPairMatchesCurrentOrAg12cR1Repair(summary.seed_candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("Summary candidate hash mismatch or AG12C-R1 repaired article state missing");
