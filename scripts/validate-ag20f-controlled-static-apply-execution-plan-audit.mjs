...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag20ePlan.candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("Execution plan candidate hash mismatch or AG12C-R1 repaired article state missing");
for (const key of [
...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag20eFileMutationOrder.candidate.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("File mutation hash mismatch or AG12C-R1 repaired article state missing");
