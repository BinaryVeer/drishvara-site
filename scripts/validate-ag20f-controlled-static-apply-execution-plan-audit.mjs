...
if (ag20ePlan.candidate.article_hash !== currentHash) fail("Execution plan candidate hash mismatch");
for (const key of [
...
if (ag20eFileMutationOrder.candidate.article_hash !== currentHash) fail("File mutation hash mismatch");
