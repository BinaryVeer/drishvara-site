...
if (ag19ePackage.candidate.article_hash !== currentHash) fail("Approval package hash mismatch");
for (const key of [
...
if (ag19eCandidate.candidate.article_hash !== currentHash) fail("Candidate summary hash mismatch");
