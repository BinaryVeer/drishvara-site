...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag16cSeed.record_under_test.article_hash, currentHash, typeof articlePath !== "undefined" ? articlePath : null)) fail("Seed dry-run hash mismatch or AG12C-R1 repaired article state missing");
