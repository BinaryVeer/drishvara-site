...
if (!hashPairMatchesCurrentOrAg12cR1Repair(ag18aCandidate.candidate_under_consideration.hash_verified, true, typeof articlePath !== "undefined" ? articlePath : null)) fail("Candidate hash must be verified or AG12C-R1 repaired article state missing");
