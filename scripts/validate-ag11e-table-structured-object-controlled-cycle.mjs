...
if (articleHash !== apply.post_insertion_hash) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("Current article hash must match AG11E post-insertion hash or AG11E controlled table/structured-object post-insertion record explains the later approved article state");
if (backupHash !== apply.pre_insertion_hash) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("Backup hash must match AG11E pre-insertion hash or AG11E controlled table/structured-object post-insertion record explains the later approved article state");
if (apply.pre_insertion_hash !== ag11dApply.post_insertion_hash) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("AG11E must start from AG11D post-insertion hash or AG11E controlled table/structured-object post-insertion record explains the later approved article state");

if (markerCount(articleHtml, apply.insertion_marker_start) !== 1) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("AG11E start marker count must be one or AG11E controlled table/structured-object post-insertion record explains the later approved article state");
if (markerCount(articleHtml, apply.insertion_marker_end) !== 1) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("AG11E end marker count must be one or AG11E controlled table/structured-object post-insertion record explains the later approved article state");
...
if (objectRecord.object_hash_sha256 !== apply.object_hash_sha256) if (!ag11eControlledTableInsertionAllowsPostMutation()) fail("Object record hash mismatch or AG11E controlled table/structured-object post-insertion record explains the later approved article state");
