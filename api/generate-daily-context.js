export default async function handler(req, res) {
  ...
  const payload = {
    ...
    word_of_the_day: getWordOfTheDay(dayIndex),
    vedic_guidance: getVedicGuidance(dayIndex),
    panchang: getPanchangPlaceholder(dayIndex),
    festivals: getFestivalPlaceholders(dayIndex)
  };

  try {
    const path = `generated/daily-context/${today}-daily-context.json`;
    ...
    await upsertGitHubFile({
      ...
      path,
      message: `Generate daily context for ${today}`,
