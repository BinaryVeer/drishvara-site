...
(() => {
  ...
  const dictionary = {
    ...
    "From daily signals to deeper reading and reflection": "दैनिक संकेतों से गहरे पठन और चिंतन तक",
    ...
    "Not live yet": "अभी लाइव नहीं",
    "No assessment, data collection or scoring is active.": "कोई आकलन, डेटा संग्रह या स्कोरिंग सक्रिय नहीं है।",
